...
//
//	mockgen -source=service.go -destination=./mocks/storage_mock.go -package=mocks -mock_names=storage=StorageMock .
//
...
func (m *StorageMock) PutFlags(ctx context.Context, flags []*models.Flag) ([]int64, error) {
	m.ctrl.T.Helper()
...
func (mr *StorageMockMockRecorder) PutFlags(ctx, flags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutFlags", reflect.TypeOf((*StorageMock)(nil).PutFlags), ctx, flags)
}
...
func (m *Mockqueue) GetFlagChan() (<-chan amqp091.Delivery, error) {
	m.ctrl.T.Helper()
...
func (mr *MockqueueMockRecorder) GetFlagChan() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFlagChan", reflect.TypeOf((*Mockqueue)(nil).GetFlagChan))
}
